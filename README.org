#+TITLE: cl-phonetic
#+PROPERTY: header-args:lisp :results raw drawer
...
#+begin_src lisp
(generate-regex 'perfect-rhyme (first (pronounce-word *dict* "Candor")))
#+end_src
...
#+begin_src lisp
(the-words (find-metapattern *dict* 'near-rhyme "Turkey"))
#+end_src
...
#+begin_src lisp
(test-metapattern *dict* 'perfect-rhyme "Wallet" "Stanford")
#+end_src
